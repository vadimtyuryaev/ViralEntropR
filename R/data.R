...
#' \itemize{
#'   \item \strong{Sample size}: 100 random sequences
...
#' reproducible sampling script are in \code{data-raw/sarscov2_ncbi.R} in
#' the package source.
#'
#' @section Provenance:
...
#'   \describe{
#'     \item{Header}{NCBI Virus format: accession, country, and collection date 
#'     metadata separated by \code{|}.}
...
#' interactive display.
#'
#' @format A named list of 13 elements (12 metadata fields plus a structured 
