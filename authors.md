...
- **Vadim Tyuryaev**. Author, maintainer.
  [](https://orcid.org/0009-0008-1361-6265)

- **Jane Heffernan**. Author.

- **Hanna Jankowski**. Author.

## Citation

Source:
[`DESCRIPTION`](https://github.com/vadimtyuryaev/ViralEntropR/blob/main/DESCRIPTION)
...
Variants*. R package version 0.6.2,
